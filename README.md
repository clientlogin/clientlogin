...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,go,kotlin,java,python,npm,mongodb,cpp,rust,typescript,redis,mysql,discordjs,postgres,sqlite,sequelize&perline=6)](https://skillicons.dev)
